...
ONTOLOGY_CONFIGS = {
    ...
    'clinvar.variant_nodes': {
        ...
        'parse_config': {
            'headers': True,
            'iri_column_name': 'alleleId',
            'data_property_map': {'alleleId': 'alleleId', 'variationId': 'variationId', 'variantType': 'variantType', 'variantName': 'variantName', 'clinicalSignificance': 'clinicalSignificance', 'reviewStatus': 'reviewStatus', 'positionGrch38': 'positionGrch38', 'sourceDatabase': 'sourceDatabase'},
        },
        'merge': False,
        'skip': False,
    },
    'clinvar.disease_variant': {
        'data_type': 'relationship',
        'relationship_type': 'variantAssociatedWithDisease',
        'inverse_relationship_type': 'diseaseHasVariant',
        'source_label': 'ClinVar',
        'source_filename': 'disease_variant.tsv',
        'parse_config': {
            'headers': True,
            'subject_node_type': 'Variant',
            'subject_column_name': 'allele_id',
            'subject_match_property': 'alleleId',
            'object_node_type': 'Disease',
            'object_column_name': 'phenotype_id',
            'object_match_property': 'xrefMeshDisease',
            'data_property_map': {'phenotype_name': 'phenotypeName', 'clinical_significance': 'clinicalSignificance'},
        },
        'merge': False,
        'skip': False,
    },
    'clinvar.gene_variant': {
        'data_type': 'relationship',
        'relationship_type': 'geneHasVariant',
        'inverse_relationship_type': 'variantAffectsGene',
        'source_label': 'ClinVar',
        ...
        'parse_config': {
            ...
            'object_match_property': 'alleleId',
            'data_property_map': {'gene_symbol': 'geneSymbol', 'clinical_significance': 'clinicalSignificance', 'variant_type': 'variantType', 'source_database': 'sourceDatabase'},
        },
        'merge': False,
        'skip': False,
    },
    ...
    'clinvar.variant_nodes': {
        ...
        'parse_config': {
            'headers': True,
            'iri_column_name': 'clinvarAlleleId',
            'data_property_map': {'clinvarAlleleId': 'clinvarAlleleId', 'variationId': 'variationId', 'variantType': 'variantType', 'chromosome': 'chromosome', 'start': 'start', 'stop': 'stop', 'referenceAllele': 'referenceAllele', 'alternateAllele': 'alternateAllele', 'assembly': 'assembly', 'sourceDatabase': 'sourceDatabase'},
        },
        'merge': True,
        'skip': False,
    },
    'clinvar.variant_disease': {
        'data_type': 'relationship',
        'relationship_type': 'variantAssociatedWithDisease',
        'inverse_relationship_type': 'diseaseHasVariant',
        'source_label': 'ClinVar',
        'source_filename': 'variant_disease.tsv',
        'parse_config': {
            'headers': True,
            'subject_node_type': 'Variant',
            'subject_column_name': 'clinvarAlleleId',
            'subject_match_property': 'clinvarAlleleId',
            'object_node_type': 'Disease',
            'object_column_name': 'condition',
            'object_match_property': 'diseaseName',
            'data_property_map': {'clinicalSignificance': 'clinicalSignificance', 'reviewStatus': 'reviewStatus'},
        },
        'merge': False,
        'skip': False,
    },
    'clinvar.variant_gene': {
        'data_type': 'relationship',
        'relationship_type': 'variantInGene',
        'inverse_relationship_type': 'geneHasVariant',
        'source_label': 'ClinVar',
        'source_filename': 'variant_gene.tsv',
        'parse_config': {
            'headers': True,
            'subject_node_type': 'Variant',
            'subject_column_name': 'clinvarAlleleId',
            ...
            'object_match_property': 'xrefNcbiGene',
            'data_property_map': {'geneSymbol': 'geneSymbol'},
        },
        'merge': False,
        'skip': False,
    },
