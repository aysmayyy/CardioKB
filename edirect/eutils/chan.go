...
func ChanToChan(inp <-chan string, depth int) <-chan string {

	if inp == nil {
		return nil
	}

	out := make(chan string, depth)
	if out == nil {
		return nil
	}
...
func StringToChan(str string, depth int) <-chan string {
...
func SliceToChan(values []string, depth int) <-chan string {
